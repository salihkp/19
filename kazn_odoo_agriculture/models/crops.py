...
class CropLocation(models.Model):
    ...
    crop_task_ids = fields.One2many(
        'crops.tasks.template', 'crop_id', string='Crop Processes')
    crop_material_ids = fields.One2many(
        'crops.materials.job', 'crop_id',
    ...
    crops_dieases_ids = fields.One2many(
        'crops.dieases', 'crops_dieases_cures_id', string='Crop Dieases')
    ...
    company_id = fields.Many2one(
        ...
        help="Company this crop belongs to.")
